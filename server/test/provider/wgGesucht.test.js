...
describe('#wgGesucht testsuite()', () => {
  ...
  it('should successfully execute wgGesucht provider', async () => {
    ...
    listings.forEach((listing) => {
      ...
      expect(listing.imageUrl).to.include('https://img.wg-gesucht.de');
    ...
    notificationObj.newListings.forEach((notify) => {
      ...
      expect(notify.imageUrl).to.include('https://img.wg-gesucht.de');
