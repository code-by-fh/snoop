...
describe('#immoswp testsuite()', () => {
  ...
  it('should successfully execute immoswp provider', async () => {
    ...
    listings.forEach((listing) => {
      ...
      expect(listing.imageUrl).to.include('https://cmcdn.de');
    ...
    notificationObj.newListings.forEach((notify) => {
      ...
      expect(notify.imageUrl).to.include('https://cmcdn.de');
