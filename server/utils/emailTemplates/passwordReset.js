          ...
          <table class="container" width="600" cellspacing="0" cellpadding="0" border="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.05);">
            <tr>
              <td style="padding:40px 40px 20px;text-align:center;">
                ...
                <h2 style="color:#111827;font-size:22px;margin-bottom:8px;">Hello, ${username} 👋</h2>
            ...
            <tr>
              <td align="center" style="padding:30px;">
                <a href="${resetUrl}" class="button" style="display:inline-block;background:#2563eb;color:#ffffff;text-decoration:none;font-weight:600;font-size:16px;padding:14px 36px;border-radius:8px;transition:background 0.3s;">
                  Reset Password
                </a>
              </td>
            </tr>
