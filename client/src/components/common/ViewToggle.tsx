...
const ListingsViewToggle: React.FC<ListingsViewToggleProps> = ({
  ...
  return (
    <div className="flex flex-col xl:flex-row gap-4 md:items-center w-full xl:w-auto">
      <div className="flex w-full xl:w-auto justify-between md:justify-start rounded-md border border-gray-200 dark:border-gray-300 bg-white dark:bg-gray-800 p-1">
