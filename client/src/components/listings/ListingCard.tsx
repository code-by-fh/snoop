...
const ListingCard: React.FC<ListingCardProps> = ({ listing }) => {
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-md dark:hover:shadow-lg transition-transform hover:scale-[1.02]">
      {/* Image / Placeholder */}
        ...
        <div className="mt-2 flex items-center text-gray-600 dark:text-gray-400">
          ...
          <span className="text-sm truncate">
            {[listing.location?.street, listing.location?.city]
              .filter(Boolean)
              .join(', ') || listing.address || 'No location'}
          </span>
        </div>
